...
export const metadata: Metadata = {
  title: 'Pricing',
  description: 'Free to build, pay only when you download. One-time $3.24 or unlimited downloads at $2/mo.',
}
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-stone-900 border border-stone-800 rounded-2xl p-8 flex flex-col">
              <div className="mb-6">
                ...
                <div className="flex items-baseline gap-2 mb-1">
                  <span className="text-4xl font-black text-stone-100">$3.24</span>
                  <span className="text-stone-500 text-sm line-through">$4.99</span>
                  <span className="bg-amber-500/20 text-amber-400 text-xs font-bold px-2 py-0.5 rounded-full">35% off</span>
                </div>
            ...
            <div className="bg-amber-500/5 border-2 border-amber-500/50 rounded-2xl p-8 flex flex-col relative">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-baseline gap-2 mb-1">
                  <span className="text-4xl font-black text-stone-100">$2</span>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-stone-900 border border-stone-800 rounded-2xl overflow-hidden">
              <div className="grid grid-cols-3 text-xs font-bold uppercase tracking-widest text-stone-500 border-b border-stone-800">
                ...
                <div className="px-6 py-4 text-center border-l border-stone-800">One-Time · $3.24</div>
                <div className="px-6 py-4 text-center border-l border-stone-800 text-amber-400">Pro · $2/mo</div>
              </div>
              {[
