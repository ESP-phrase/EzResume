...
export const metadata: Metadata = {
  ...
  title: {
    default: “seoForge — Build a Resume That Gets You Hired”,
    template: “%s | seoForge”,
  },
  description: “seoForge rewrites your resume into achievement-focused language and exports a polished PDF in minutes. Used by professionals at Google, Stripe, Airbnb and more.”,
  ...
  openGraph: {
    ...
    url: APP_URL,
    siteName: “seoForge”,
    title: “seoForge — Build a Resume That Gets You Hired”,
    description: “Rewrites your experience into language that gets responses. Polished PDF in minutes.”,
    images: [{ url: “/og.png”, width: 1200, height: 630, alt: “seoForge” }],
  },
  twitter: {
